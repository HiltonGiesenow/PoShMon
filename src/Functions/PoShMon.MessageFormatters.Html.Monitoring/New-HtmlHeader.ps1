Function New-HtmlHeader
{
    ...
    $emailSection += '<tr><td style="background-color: lightgray">&nbsp;</td><td style="background-color: #1D6097; color: #FFFFFF; Padding: 20px;"><h1>PoShMon Monitoring Report' + $ExtraTitle + '</h1></td><td style="background-color: lightgray">&nbsp;</td></tr>'
