Function Test-EventLogs
{
    ...
    {   
        ...
        foreach ($serverName in $PoShMonConfiguration.General.ServerNames)
        {
            ...
            $events = Get-WmiObject win32_NTLogEvent -ComputerName $PoShMonConfiguration.General.ServerNames -filter "(logfile='Application') AND (Type ='$severityCode') And TimeGenerated > '$wmiStartDate'" | Group-Object EventCode, Message
